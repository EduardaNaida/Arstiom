...
// Checks if an login is valid. If it is, load the corresponding login page.
...
// Logs out, and updates html to non-logged in 
...
// Displays who logged in, and shows the logout button
...
// Checks who logged in based on credentials, and loads corresponding page

function whoLoggedIn(user) {
    console.log(user);
    switch(user) {
        case "0": 
        break;
